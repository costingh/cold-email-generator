...
function CustomersSidebar({handleOpenCreateContactModal, segments, handleOpenCreateSegmentModal }) {
    ...
    return (
        <div className="large-sidebar">
            ...
            <div className={`sidebar-inner ${(isSegmentsMenuOpened || isListsMenuOpened) && 'hidden'}`}>
                <div className="btn-filled text-center max-w-80 mb-4" onClick={handleOpenCreateContactModal}>
                    <Icon icon='plus' />
                ...
                {/* <div className="item" onClick={() => openSubMenu('lists')}>
                    <div>
                        <div className="icon">
                            <svg
                                width="16"
                    ...
                    <div className={`right ${isListsMenuOpened && 'opened'}`}>
            ...
            {isListsMenuOpened &&
                <div className="sidebar-submenu">
                    <div className="submenu-header mt-4">
                        <div className="icon" onClick={() => openSubMenu('lists')}   >
                            <svg
                                className="ml-1 h-16 w-16"
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                    ...
                    <div className="sidebar-title mt-2">Lists of contacts</div>
