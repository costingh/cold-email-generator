...
function PreviewEmail({ closeModal, show, emailSubject, emailBody }) {
    return (
        <>
            {show && <>
                <div id="right-sidebar-modal">
                </div>
                <div id="center-sidebar-modal-inner">
                    <div className="d-flex space-between align-items-center heading mb-4">
                        <h1>Example of an AI generated email</h1>
                    ...
                    <input id='email_subject' className='w-100 mb-4' type="text" value={emailSubject} />
                    <label htmlFor="email_preview" className='mt-4'>Email</label>
                    <textarea className='w-100' style={{height: 'calc(100% - 220px)'}} name="email_preview" id="email_preview" cols="30" rows="11" defaultValue={emailBody}></textarea>
